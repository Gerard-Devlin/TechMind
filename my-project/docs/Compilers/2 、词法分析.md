...
上图可以写成
$$
M=(\{a,b\},\{q_0,q_1,q_2\},q_0,\{q_2\},\delta)
$$
...
| 接受状态集合 | $F$      | $F={q_2}$                | 字符串读取完毕后，如果自动机停留在集合 $F$ 中的状态，则该字符串被接受。状态图中接受状态通常画成**双圆圈** |
...
\delta =
\begin{cases}
(q_0,a)\rightarrow q_1,\quad (q_0,b)\rightarrow q_0,\\
(q_1,a)\rightarrow q_2,\quad (q_1,b)\rightarrow q_1,\\
(q_2,a)\rightarrow q_2,\quad (q_2,b)\rightarrow q_2
\end{cases}
$$
这个 $M$ 所表示的自动机接受的字符串是 $\boxed{\text{所有至少包含两个 }a\text{ 的字符串}}$
...
\delta =
\begin{cases}
(q_0,a)\rightarrow \{q_0,q_1\},\quad (q_0,b)\rightarrow \{q_1\},\\
(q_1,a)\rightarrow \varnothing,\quad (q_1,b)\rightarrow \{q_0,q_1\}
\end{cases}
$$
